/*
  # Initial Schema Setup for Dynamic Celebrity Booking Platform

  1. New Tables
    - `admin_users` - Store admin user information for authentication
    - `categories` - Store celebrity categories (Music, Film, TV, etc.)
